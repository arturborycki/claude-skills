-- =====================================================
-- TD_ACF - UAF Data Preparation
-- =====================================================
-- Purpose: Prepare time series data for UAF auto-correlation function
-- Function: TD_ACF
...
DROP TABLE IF EXISTS {USER_DATABASE}.uaf_acf_input;
CREATE MULTISET TABLE {USER_DATABASE}.uaf_acf_input AS (
    SELECT
        {TIMESTAMP_COLUMN} as time_index,
...
SELECT
    'UAF TD_ACF Readiness' as status_type,
    COUNT(*) as n_observations,
    CASE
    ...
    CASE
        WHEN COUNT(*) >= 30 THEN 'READY FOR TD_ACF'

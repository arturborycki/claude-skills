-- Complete TD_ACF UAF Workflow Template
...
-- 2. TD_ACF Execution
DROP TABLE IF EXISTS td_acf_results;
CREATE MULTISET TABLE td_acf_results AS (
    SELECT * FROM TD_ACF (
        ...
        -- MissingValueOption (configure based on your analysis requirements)
...
SELECT * FROM td_acf_results
ORDER BY time_index;

-- 6. Cleanup (optional)
-- DROP TABLE uaf_prepared_data;
-- DROP TABLE td_acf_results;

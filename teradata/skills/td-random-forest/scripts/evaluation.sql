...
-- =====================================================
-- Purpose: Comprehensive evaluation of random forest classifier
...
SELECT
    'Random Forest Evaluation Summary' as report_type,
    (SELECT COUNT(*) FROM {database}.rf_predictions_out) as total_test_samples,
    (SELECT COUNT(DISTINCT {target_column}) FROM {database}.rf_predictions_out) as num_classes,
    ...
    (SELECT AVG(confidence) FROM {database}.rf_predictions_out) as avg_prediction_confidence,

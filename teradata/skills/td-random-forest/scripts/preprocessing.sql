-- =====================================================
-- Data Preprocessing for TD_RandomForest
-- =====================================================
-- Purpose: Prepare data for random forest classification
...
DROP TABLE IF EXISTS {database}.rf_train_test_split;
CREATE MULTISET TABLE {database}.rf_train_test_split AS (
    SELECT
        *,
        CASE
...
/*
DROP TABLE IF EXISTS {database}.rf_encoded_data;
CREATE MULTISET TABLE {database}.rf_encoded_data AS (
    SELECT
        t.*,
    ...
    FROM {database}.rf_train_test_split t
) WITH DATA;
*/
...
/*
DROP TABLE IF EXISTS {database}.rf_preprocessed;
CREATE MULTISET TABLE {database}.rf_preprocessed AS (
    SELECT
        {id_column},
        {target_column},
        train_flag,
...
--    - Scaling is NOT required for random forests
...
--    - Use rf_train_test_split table for modeling
--
-- =====================================================

-- UAF Multi-Function Pipeline Template for TD_WINDOW
...
-- Pipeline Stage 2: TD_WINDOW Processing
DROP TABLE IF EXISTS pipeline_td_window_results;
CREATE MULTISET TABLE pipeline_td_window_results AS (
...
FROM pipeline_td_window_results;

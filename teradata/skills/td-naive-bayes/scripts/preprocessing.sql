-- =====================================================
-- Data Preprocessing for TD_NaiveBayes
-- =====================================================
-- Purpose: Prepare data for naive bayes classification
...
DROP TABLE IF EXISTS {database}.nb_train_test_split;
CREATE MULTISET TABLE {database}.nb_train_test_split AS (
    SELECT
        *,
        CASE
...
/*
DROP TABLE IF EXISTS {database}.nb_encoded_data;
CREATE MULTISET TABLE {database}.nb_encoded_data AS (
    SELECT
        t.*,
    ...
    FROM {database}.nb_train_test_split t
) WITH DATA;
*/
...
/*
DROP TABLE IF EXISTS {database}.nb_preprocessed;
CREATE MULTISET TABLE {database}.nb_preprocessed AS (
    SELECT
        {id_column},
        {target_column},
        train_flag,
...
--    - Scaling is NOT required for naive bayess
...
--    - Use nb_train_test_split table for modeling
--
-- =====================================================

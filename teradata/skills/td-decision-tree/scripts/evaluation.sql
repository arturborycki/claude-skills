...
-- =====================================================
-- Purpose: Comprehensive evaluation of decision tree classifier
...
SELECT
    'Decision Tree Evaluation Summary' as report_type,
    (SELECT COUNT(*) FROM {database}.dt_predictions_out) as total_test_samples,
    (SELECT COUNT(DISTINCT {target_column}) FROM {database}.dt_predictions_out) as num_classes,
    ...
    (SELECT AVG(confidence) FROM {database}.dt_predictions_out) as avg_prediction_confidence,

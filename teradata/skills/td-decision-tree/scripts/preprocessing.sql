-- =====================================================
-- Data Preprocessing for TD_DecisionTree
-- =====================================================
-- Purpose: Prepare data for decision tree classification
...
DROP TABLE IF EXISTS {database}.dt_train_test_split;
CREATE MULTISET TABLE {database}.dt_train_test_split AS (
    SELECT
        *,
        CASE
...
/*
DROP TABLE IF EXISTS {database}.dt_encoded_data;
CREATE MULTISET TABLE {database}.dt_encoded_data AS (
    SELECT
        t.*,
    ...
    FROM {database}.dt_train_test_split t
) WITH DATA;
*/
...
/*
DROP TABLE IF EXISTS {database}.dt_preprocessed;
CREATE MULTISET TABLE {database}.dt_preprocessed AS (
    SELECT
        {id_column},
        {target_column},
        train_flag,
...
--    - Use dt_train_test_split table for modeling
--
-- =====================================================

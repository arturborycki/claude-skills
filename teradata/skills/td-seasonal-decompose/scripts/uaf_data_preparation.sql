-- =====================================================
-- TD_SeasonalDecompose - UAF Data Preparation
-- =====================================================
-- Purpose: Prepare time series data for UAF seasonal decomposition
...
DROP TABLE IF EXISTS {USER_DATABASE}.uaf_seasonal_decompose_input;
CREATE MULTISET TABLE {USER_DATABASE}.uaf_seasonal_decompose_input AS (
    SELECT
        {TIMESTAMP_COLUMN} as time_index,
...
SELECT
    'UAF TD_SeasonalDecompose Readiness' as status_type,
    COUNT(*) as n_observations,
    CASE
    ...
    CASE
        WHEN COUNT(*) >= 30 THEN 'READY FOR TD_SeasonalDecompose'

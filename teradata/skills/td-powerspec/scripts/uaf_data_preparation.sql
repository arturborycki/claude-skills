-- =====================================================
-- TD_PowerSpectrum - UAF Data Preparation
-- =====================================================
-- Purpose: Prepare time series data for UAF power spectrum analysis
...
DROP TABLE IF EXISTS {USER_DATABASE}.uaf_powerspec_input;
CREATE MULTISET TABLE {USER_DATABASE}.uaf_powerspec_input AS (
    SELECT
        {TIMESTAMP_COLUMN} as time_index,
...
SELECT
    'UAF TD_PowerSpectrum Readiness' as status_type,
    COUNT(*) as n_observations,
    CASE
    ...
    CASE
        WHEN COUNT(*) >= 30 THEN 'READY FOR TD_PowerSpectrum'

...
1. **Stationarity testing**: Advanced UAF-based analysis
2. **Unit root tests**: Advanced UAF-based analysis
3. **Statistical validation**: Advanced UAF-based analysis
4. **Model prerequisites**: Advanced UAF-based analysis
...
- **`td_stationarity_test_workflow.sql`**: Complete TD_STATIONARITY_TEST implementation

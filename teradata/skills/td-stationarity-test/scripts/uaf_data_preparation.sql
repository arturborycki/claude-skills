-- =====================================================
-- TD_StationarityTest - UAF Data Preparation
-- =====================================================
-- Purpose: Prepare time series data for UAF stationarity testing
-- Function: TD_StationarityTest
...
DROP TABLE IF EXISTS {USER_DATABASE}.uaf_stationarity_test_input;
CREATE MULTISET TABLE {USER_DATABASE}.uaf_stationarity_test_input AS (
    SELECT
        {TIMESTAMP_COLUMN} as time_index,
...
SELECT
    'UAF TD_StationarityTest Readiness' as status_type,
    COUNT(*) as n_observations,
    CASE
    ...
    CASE
        WHEN COUNT(*) >= 30 THEN 'READY FOR TD_StationarityTest'

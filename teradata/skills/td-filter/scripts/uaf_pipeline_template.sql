-- UAF Multi-Function Pipeline Template for TD_FILTER
...
-- Pipeline Stage 2: TD_FILTER Processing
DROP TABLE IF EXISTS pipeline_td_filter_results;
CREATE MULTISET TABLE pipeline_td_filter_results AS (
...
FROM pipeline_td_filter_results;

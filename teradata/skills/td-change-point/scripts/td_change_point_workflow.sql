-- =====================================================
-- TD_ChangePointDetector - Complete UAF Workflow
-- =====================================================
-- Purpose: Change Point Detection using Teradata UAF
-- Function: TD_ChangePointDetector
...
-- ============================================================================
-- STEP 1: Execute TD_ChangePointDetector for Analysis
-- ============================================================================

-- Execute UAF function with optimal parameters
DROP TABLE IF EXISTS {USER_DATABASE}.change_point_results;
CREATE MULTISET TABLE {USER_DATABASE}.change_point_results AS (
    SELECT * FROM TD_ChangePointDetector (
        ...
        -- Refer to Teradata UAF documentation for TD_ChangePointDetector parameters
    ) AS dt
) WITH DATA;
...
SELECT
    'TD_ChangePointDetector Analysis Complete' as status,
    (SELECT COUNT(*) FROM {USER_DATABASE}.uaf_change_point_input) as input_observations,
    (SELECT COUNT(*) FROM {USER_DATABASE}.change_point_results) as output_results,
...
-- ============================================================================
-- DROP TABLE {USER_DATABASE}.change_point_results;

-- ============================================================================
-- UAF TD_ChangePointDetector WORKFLOW CHECKLIST:
-- ============================================================================
/*

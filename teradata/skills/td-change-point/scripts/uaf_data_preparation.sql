-- =====================================================
-- TD_ChangePointDetector - UAF Data Preparation
-- =====================================================
-- Purpose: Prepare time series data for UAF change point detection
...
DROP TABLE IF EXISTS {USER_DATABASE}.uaf_change_point_input;
CREATE MULTISET TABLE {USER_DATABASE}.uaf_change_point_input AS (
    SELECT
        {TIMESTAMP_COLUMN} as time_index,
...
FROM {USER_DATABASE}.uaf_change_point_input;
...
SELECT
    'UAF TD_ChangePointDetector Readiness' as status_type,
    COUNT(*) as n_observations,
    CASE
    ...
    CASE
        WHEN COUNT(*) >= 30 THEN 'READY FOR TD_ChangePointDetector'

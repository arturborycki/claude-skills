-- UAF Multi-Function Pipeline Template for TD_IFFT
...
-- Pipeline Stage 2: TD_IFFT Processing
DROP TABLE IF EXISTS pipeline_td_ifft_results;
CREATE MULTISET TABLE pipeline_td_ifft_results AS (
    SELECT * FROM TD_IFFT (
        ON pipeline_input
        USING

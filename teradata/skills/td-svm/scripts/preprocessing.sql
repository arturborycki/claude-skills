-- =====================================================
-- Data Preprocessing for TD_SVM
-- =====================================================
-- Purpose: Prepare data for support vector machine classification
...
DROP TABLE IF EXISTS {database}.svm_train_test_split;
CREATE MULTISET TABLE {database}.svm_train_test_split AS (
    SELECT
        *,
        CASE
...
/*
DROP TABLE IF EXISTS {database}.svm_encoded_data;
CREATE MULTISET TABLE {database}.svm_encoded_data AS (
    SELECT
        t.*,
    ...
    FROM {database}.svm_train_test_split t
) WITH DATA;
*/
...
/*
DROP TABLE IF EXISTS {database}.svm_preprocessed;
CREATE MULTISET TABLE {database}.svm_preprocessed AS (
    SELECT
        {id_column},
        {target_column},
        train_flag,
...
--    - Scaling is NOT required for support vector machines
...
--    - Use svm_train_test_split table for modeling
--
-- =====================================================

-- UAF Multi-Function Pipeline Template for TD_CORRELATION
...
-- Pipeline Stage 2: TD_CORRELATION Processing
DROP TABLE IF EXISTS pipeline_td_correlation_results;
CREATE MULTISET TABLE pipeline_td_correlation_results AS (
...
FROM pipeline_td_correlation_results;

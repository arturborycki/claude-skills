...
-- =====================================================
-- Purpose: Comprehensive evaluation of decision forest classifier
...
SELECT
    'Decision Forest Evaluation Summary' as report_type,
    (SELECT COUNT(*) FROM {database}.df_predictions_out) as total_test_samples,
    (SELECT COUNT(DISTINCT {target_column}) FROM {database}.df_predictions_out) as num_classes,
    ...
    (SELECT AVG(confidence) FROM {database}.df_predictions_out) as avg_prediction_confidence,

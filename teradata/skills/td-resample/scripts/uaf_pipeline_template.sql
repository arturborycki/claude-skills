-- UAF Multi-Function Pipeline Template for TD_RESAMPLE
...
-- Pipeline Stage 2: TD_RESAMPLE Processing
DROP TABLE IF EXISTS pipeline_td_resample_results;
CREATE MULTISET TABLE pipeline_td_resample_results AS (
...
FROM pipeline_td_resample_results;

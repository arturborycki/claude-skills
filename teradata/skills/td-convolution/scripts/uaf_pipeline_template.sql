-- UAF Multi-Function Pipeline Template for TD_CONVOLUTION
...
-- Pipeline Stage 2: TD_CONVOLUTION Processing
DROP TABLE IF EXISTS pipeline_td_convolution_results;
CREATE MULTISET TABLE pipeline_td_convolution_results AS (
...
FROM pipeline_td_convolution_results;
